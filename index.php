                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <h1 class="display-1 text-white animated slideInRight mb-3"><?php echo APP_NAME . NAME2 ?></h1>
                                    <p class="mb-5 animated slideInRight"><?php echo NAME ?> is most uniqe dispansery in kabuku with different services inlucuding patient rooms. We are avalible 24/7 Also we have hospitality nurse.</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <h1 class="display-1 text-white animated slideInLeft mb-3">Skilled Doctors & Lab Assistants</h1>
                                    <p class="mb-5 animated slideInLeft">We have talented and Skilled doctors & LAB Assistants working 24/7.</p>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-6 mb-4">Trusted Lab and Latest Lab Technologies.</h1>
                    <p class="mb-4">If you are looking for Dispansery welcome <?php echo NAME ?> we have fast services provder with talented and Skilled doctors & LAB Assistants working 24/7.</p>
                    <div class="row g-4 g-sm-5 justify-content-center">
                        ...
                        <div class="col-sm-6 text-start">
                            <div class="about-fact btn-square flex-column rounded-circle bg-secondary me-sm-auto">
                                <p class="text-white mb-0">Partient Rooms</p>
            ...
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Pertient Rooms</h5>
                        <p class="mb-0">We have rooms for our partient, our room is very freindly and afordeble price.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Skilled Doctors</h5>
                        <p class="mb-0"><?php echo NAME ?> dispansery we have Skilled and Talented Doctors with fast services and working experience.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">You don't need to scared about our price we provide afordeble for all people.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0"><?php echo NAME ?> Doctors, customer care and our system is available 24/7.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 pt-lg-5">
                    <div class="bg-white p-5 mt-lg-5">
                        ...
                        <p class="mb-4 wow fadeIn" data-wow-delay="0.4s"><?php echo NAME ?> we have and we provide fast and standard Medical Test and Laboratory solution within few moment.</p>
                        <div class="row g-5 pt-2 mb-5">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                ...
                                <span>We have the most experience doctors work since 6 years ago.</span>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <span>We have morden Microscrop with the latest Technology.</span>
                            </div>
                        </div>
                        ...
                        <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                            <div class="d-flex align-items-center justify-content-center" style="min-height: 300px;">
                                <button type="button" class="btn-play" data-bs-toggle="modal"
                                    data-src="<?php echo YT_VIDEO ?>" data-bs-target="#videoModal">
                                    <span></span>
                                </button>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p>To Ensure that you stay safe and healthly we follow you any place you are. fill below form to get our services at home.</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form action="./Controller/apointment.php" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <input type="tel" class="form-control" name="number"  id="mobile" placeholder="Your Mobile">
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <select class="form-select" name="service" id="service">
                                    ...
                                    <option value="biochemistry">Biochemistry Tests</option>
                                    <option value="histopatology">Histopatology Tests</option>
                                </select>
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                ...
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-6 mb-3">Mr. Chikira</h1>
                    <p class="mb-1">CEO & Founder</p>
                    <p class="mb-5"><?php echo ADRESS; ?></p>
        ...
        <div class="container">
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <p class="fs-5 mb-4">Honelo best choice for you and your family health.</p>
