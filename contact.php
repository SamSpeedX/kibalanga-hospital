    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p class="mb-5">you can all our customer care directily or send us email or fill the form below.</p>
            </div>
                ...
                <div class="col-lg-6">
                    <a href="tel:+0123456789" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h2 class="text-white mb-0"><?php echo OFFICE_NUMBER ?></h2>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a href="mailto:info@example.com" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h2 class="text-white mb-0"><?php echo OFFICE_EMAIL ?></h2>
                        </div>
                    </a>
                </div>
            </div>
